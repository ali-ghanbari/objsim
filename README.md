...
different methods with entirely different bodies, and altering. As per the previous empirical
studies <sup>:one:,:two:,:three:</sup>, most of such changes are unlikely to be genuine fixes
for the bugs.
