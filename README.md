...
control flow of the program hence in the objects that it computes, e.g., deleting a block of code
(which redirects control flow to a method with entirely different body) and calling different
methods with entirely different bodies, and altering. As per the previous empirical studies
