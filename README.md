...
ObjSim's demo paper has been accepted for publication in Proceedings of the 29th
ACM SIGSOFT International Symposium on Software Testing and Analysis ([ISSTA'20](https://conf.researchr.org/track/issta-2020/issta-2020-tool-demonstration#Accepted-Papers)). Please use the following
BibTeX snippet to cite this work.
...
and is part of Ali's Ph.D. dissertation. All your questions and comments are welcomed.